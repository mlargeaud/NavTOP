...
classdef file_writing_functions
    ...
    methods(Static)
        ...
        function PropData2File(case_name, prop_res)
            ...
            fprintf(fileID, ...
                '%-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t %-22s \t \t\n', ...
                'Time (s)', 'x (ECI)', 'y (ECI)', 'z (ECI)', ...
            ...
            fprintf(fileID, ...
                ...
                '----------------------', '----------------------', '----------------------', ...
                '----------------------', '----------------------', '----------------------');
            fprintf(fileID, '%+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e \t \t %+.15e\n', prop_res');
            fclose(fileID);
